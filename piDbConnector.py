"""Python to SQL connector (LOCAL)
Interfaces between python and the local SQL database and has functions to work
...
Major revisions by Colleen Blaho
...
def getPassword() :
	...
	Returns:
		Password as string
	"""
	with open('localPassword.txt','r') as file : ##!!
		pw = file.read().strip()
	return pw
